# applicable for russian plates only

# Usage example:  python3 object_detection_yolo.py --video=car.mp4
#                 python3 object_detection_yolo.py --image=car1.jpg
...
def drawPred(classId, conf, left, top, right, bottom):
    ...
    cv.rectangle(frame, (left, top), (right, bottom), (51, 52, 255), 3)
